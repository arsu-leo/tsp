...
class TravelFactoryBCV3
{
  public function create(array $route, int $newCity, array $distances, float $previousWeight, float $jumpWeight) : TravelBCV3
  {
    ...
    return new TravelBCV3($route, $newCity, $travels, $distances, $weight);
  }
