...
class TravelFactoryBCv1
{
  public function create(array $route, int $newCity, array $distances, float $previousWeight, float $jumpWeight) : TravelBCV1
  {
    ...
    return new TravelBCV1($route, $newCity, $travels, $distances, $weight);
  }
