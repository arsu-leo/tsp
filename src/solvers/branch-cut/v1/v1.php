...
/**
 * Adding a cut operation to set a upper bound that sets the best found so far
 * At this point I was sure I had a working solution that would give the best possible path, but...
 * The first problem is that we could get into a worst case scenario as hard as the worst possible for brute force
 */

class BranchCutTravelerSolverV1
{
  public function __construct(array $distances)
  {
    ...
    $this->travelFactory = new TravelFactoryBCV1();
    $this->cut        = INF;
  }
