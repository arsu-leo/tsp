...
class TravelFactoryBBv1
{
  public function create(array $route, int $newCity, array $distances, float $previousWeight, float $jumpWeight) : TravelBBV1
  {
    ...
    return new TravelBBV1($route, $newCity, $travels, $distances, $weight);
  }
